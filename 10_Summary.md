...
flowchart TD
    ...
    %% Section 1
    B --> B1[Types of IPR]
    B1 --> |Invention| P[Patent]
    B1 --> |Expression| CR[Copyright]
    B1 --> |Brand| TM[Trademark]
    B1 --> |Appearance| ID[Industrial Design]
    B1 --> |Place| GI[Geographical Indication]
    B1 --> |Confidential| TS[Trade Secret]

    %% Section 2
    C --> C1[International]
    C1 --> |1883| Paris[Paris Conv. - Industrial]
    C1 --> |1886| Berne[Berne Conv. - Copyright]
    C1 --> |1967| WIPO[WIPO - Cooperation]
    C1 --> |1995| TRIPS[TRIPS - Min. Standards]
    
    C --> C2[India]
    C2 --> |Admin| CGPDTM[CGPDTM under DPIIT]
    C2 --> |1970| PatAct[Patents Act 1970]
...
mindmap
  root((IPR MASTER))
    ...
    GLOBAL vs INDIA
      Global Treaties
        Paris 1883 Industrial
        Berne 1886 Copyright
        TRIPS 1995 Min Standards
        WIPO Cooperation
      Indian System
        CGPDTM
        Patents Act 1970
